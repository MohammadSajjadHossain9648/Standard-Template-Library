...
/*
    Hash policy:
    1.load_factor() - Returns the current load factor in the unordered_set container. The load factor is the ratio
    ...
    3.rehash() - Set the number of buckets in the container of unordered_set to given size or more. rehash which is
    used to set the number of buckets in the container of unordered_set to given size or more. If size is greater than
    ...
    4.reserve() - Used to request capacity change of unordered_set. reserve which is used to request capacity change of
    unordered_set. It sets the number of buckets in the container to contain at least n elements. If n is greater than
