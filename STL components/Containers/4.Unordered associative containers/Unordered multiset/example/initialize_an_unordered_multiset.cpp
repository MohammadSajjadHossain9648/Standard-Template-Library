...
using namespace std;
/*
    always remember: whatever you input in unordered_multiset, it always take unique values.
*/
int main()
{
...
// initialize in unordered_multiset
    ...
    cout<<"unordered_multiset<int> v2 = ";
    for(auto i: v2)
    {
        cout<<i<<" ";
    }
...
// iterator
    ...
    //output:
    //    enter the length of unordered_multiset: 5
    //    unordered_multiset<int> v :
    //    10
    //    20
    //    30
    ...
    //    40
    //
    //    unordered_multiset<int> v = 40 30 20 10 10
