...
/*
    to know more: https://www.geeksforgeeks.org/the-c-standard-template-library-stl/
                  ...
                  https://cplusplus.com/reference/unordered_multimap/unordered_multimap/
...
/*
    ...
    to be inserted is unique and does not already exist in the unordered_multimap.
    ...
    element is.
    8.swap() - This function is used to exchange the contents of two unordered_multimaps but the unordered_multimaps must be
    ...
    3.rehash() - map the number of buckets in the container of unordered_multimap to given size or more.
    4.reserve() - Used to request capacity change of unordered_multimap.
