...
//3.empty
    // checks if the unordered_multimap is empty or not
    if (v.empty() == false)
...
//4.find
    ...
    {
        cout<<"\nsearching value didnot found in the unordered_multimap.\n";
    }



    //example 2: find the value 5 and delete it from unordered_multimap
    v.erase(v.find(5));
    ...
    */
    ...
    cout<<"\nafter delete 5 from unordered_multimap\n";
    cout<<"\nmultimap<int, string> v\nid\tname\n";
    for(auto i: v)
    {
        cout<<i.first<<"\t"<<i.second<<endl;
...
//5.count  -> same as find
    ...
    unordered_multimap<int, string> v1 = {{2,"sakib"},{4,"asif"},{6,"liton"},{8,"tamim"},{10,"afif"}};
    ...
    for(auto i=1; i<=10; i++)
    {
        ...
        {
           cout<<"\nsearching value "<<i<<" didnot found in the unordered_multimap.";
        }
    }
    cout<<endl;
...
//6.equal_range which gives the result of both the lower_bound and the upper_bound of any value.
    unordered_multimap<int, string> v3 = {{2,"sakib"},{1,"asif"},{5,"liton"},{3,"tamim"},{4,"afif"}};
    ...
    //
    //    found by count and the searching value is 3
    //    searching value 1 didnot found in the unordered_multimap.
    //    searching value 2 found by count
    //    searching value 3 didnot found in the unordered_multimap.
    //    searching value 4 found by count
    //    searching value 5 didnot found in the unordered_multimap.
    //    searching value 6 found by count
    //    searching value 7 didnot found in the unordered_multimap.
    //    searching value 8 found by count
    //    searching value 9 didnot found in the unordered_multimap.
